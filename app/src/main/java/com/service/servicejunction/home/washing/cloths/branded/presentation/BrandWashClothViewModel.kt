...
//            Brand("Reebok"), Brand("Levi's"), Brand("Gucci"),
//            Brand("Zara"), Brand("H&M"), Brand("Calvin Klein"),
//            Brand("Tommy Hilfiger"), Brand("Louis Vuitton"), Brand("Prada"),
//            Brand("Versace"), Brand("Burberry"), Brand("Armani"),
//            Brand("Diesel"), Brand("Under Armour"), Brand("New Balance"),
//            Brand("Uniqlo"), Brand("Ralph Lauren")
//        )
//    }
